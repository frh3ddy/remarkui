...
export default View.extend({
    ...
    initialize(options) {
        ...
        const mapMergedStream = mergedStream.map((stream) => {
            ...
            const scatrans = Transform.thenMove(Transform.aboutOrigin([scaleOriginX, scaleOriginY], scale), stream.translate)
        ...
        if (color || border) {
            ...
            if (needsOutput) {
                const gestureInput = new GenericInput(
                    ['mouse', 'touch'],
                )
